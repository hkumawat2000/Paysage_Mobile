...
class SellCollateralResponseBean extends ModelWrapper<SellData>{
  String? message;
  SellData? sellData;

  SellCollateralResponseBean({this.message, this.sellData});

  SellCollateralResponseBean.fromJson(Map<String, dynamic> json) {
