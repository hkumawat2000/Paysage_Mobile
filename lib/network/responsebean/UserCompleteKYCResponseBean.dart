...
class UserCompleteKYCResponseBean extends ModelWrapper<KycData>{
  String? message;
  KycData? kycData;

  UserCompleteKYCResponseBean({this.message, this.kycData});

  UserCompleteKYCResponseBean.fromJson(Map<String, dynamic> json) {
    message = json['message'];
    kycData =
    json['data'] != null ? new KycData.fromJson(json['data']) : null;
  }
