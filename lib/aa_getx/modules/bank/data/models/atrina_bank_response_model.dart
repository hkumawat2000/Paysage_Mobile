...
class AtrinaBankResponseModel {
  String? message;
  AtrinaBankData? atrinaBankData;

  AtrinaBankResponseModel({this.message, this.atrinaBankData});

  AtrinaBankResponseModel.fromJson(Map<String, dynamic> json) {
  ...
  AtrinaBankResponseEntity toEntity() =>
      AtrinaBankResponseEntity(
        message: message,
        atrinaBankData: atrinaBankData?.toEntity(),
