...
class ProcessCartResponseModel {
  String? message;
  ProcessCartData? processCartData;

  ProcessCartResponseModel({this.message, this.processCartData});

  ProcessCartResponseModel.fromJson(Map<String, dynamic> json) {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.processCartData != null) {
      data['data'] = this.processCartData!.toJson();
    }
    return data;
  }

  ProcessCartResponseEntity toEntity() =>
      ProcessCartResponseEntity(
        message: message,
        processCartData: processCartData?.toEntity(),
...
class ProcessCartData {
  ...
  ProcessCartDataEntity toEntity() =>
      ProcessCartDataEntity(
