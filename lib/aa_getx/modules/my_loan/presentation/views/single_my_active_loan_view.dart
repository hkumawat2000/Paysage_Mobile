...
//        body: getMyLoansList()
  ...
  Widget noLoan() {
    return Visibility(
      visible: controller.loanDialogVisibility.value,
      child: AlertDialog(
              ...
              Row(
                ...
                children: <Widget>[
                  GestureDetector(
                    ...
                    onTap: ()=> controller.loanDialogVisibility.value = false,
                  ),
                ],
              ),
              Center(
              ...
              Container(
                ...
                child: Material(
                  ...
                  child: MaterialButton(
                    shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(35)),
                    minWidth: Get.width,
                    onPressed: ()=> controller.loanDialogVisibility.value = false,
                    child: Text(
                      Strings.ok,
                      style:
                              ...
                              Row(
                                children: [
                                  ...
                                  GestureDetector(
                                    ...
                                    onTap: ()=>
                                      commonDialog(
                                          controller.interest.value!.infoMsg, 0),
                                  ),
                                ],
                              ),
                              SizedBox(height: 5),
                              subHeadingText(controller.interest.value!.totalInterestAmt !=
                                  null
                                  ? controller.interest.value!.totalInterestAmt! < 0
                                  ? negativeValue(
                                  controller.interest.value!.totalInterestAmt!)
                          ...
                          children: <Widget>[
                            ...
                            SizedBox(
                              child: ElevatedButton(
                                ...
                                onPressed: ()=> controller.payNowInterestScreenClicked(),
                                child: FittedBox(
                                  fit: BoxFit.fitWidth,
                                  child: Text(
                                    Strings.pay_now,
                ...
                children: <Widget>[
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        SizedBox(height: 5),
                        subHeadingText(controller.marginShortfall
                            .value!.minimumCashAmount! <
                            0
                            ? negativeValue(
                            controller.marginShortfall.value!.minimumCashAmount!)
                  ...
                  Column(children: [
                    ...
                    ElevatedButton(
                      ...
                      onPressed: ()=> controller.actionTakenOrRequestPendingClicked(),
                      child: Text(
                        controller.marginShortfall.value!.status == "Request Pending"
                            ? "Action Taken"
                            : Strings.take_action,
                        style: TextStyle(
                            fontSize: 10,
  ...
  Widget recentTransactionItem(List<TransactionsEntity> transactionList, index) {
  ...
  termsCondition(GlobalKey<ScaffoldState> _scaffoldkey) {
    return Get.dialog(
      AlertDialog(
          backgroundColor: Colors.white,
          shape: RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(15.0))),
                ...
                Container(
                  ...
                  child: Material(
                    ...
                    child: MaterialButton(
                      ...
                      onPressed: () async {
                        Get.back();
                        termsCondition(controller.scaffoldKey);
                      },
                      child: Text(
                        "Proceed",
                        style:
...
Future<void> showCancelDialog(value) async {
  return Get.dialog<void>(
      barrierDismissible: false, // user must tap button!
      AlertDialog(
...
Future<void> showSuccessDialog(value, fileId) async {
  return Get.dialog<void>(
      barrierDismissible: false, // user must tap button!
      AlertDialog(
        ...
        actions: <Widget>[
          TextButton(
            ...
            onPressed: () {
              Get.back();
              Get.find<SingleMyActiveLoanController>().createTopUp();
            },
          ),
        ],
      )
...
Future<void> showFailDialog(value, fileId) async {
  return Get.dialog<void>(
      barrierDismissible: false, // user must tap button!
      AlertDialog(
        ...
        actions: <Widget>[
          ...
          TextButton(
            ...
            onPressed: () {
              Get.back();
              Get.find<SingleMyActiveLoanController>().eSignProcess(value, fileId);
            },
          ),
        ],
      )
