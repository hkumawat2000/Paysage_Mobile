...
class LoanSummaryResponseModel {
  String? message;
  LoanSummaryData? loanSummaryData;

  LoanSummaryResponseModel({this.message, this.loanSummaryData});

  LoanSummaryResponseModel.fromJson(Map<String, dynamic> json) {
    message = json['message'];
    loanSummaryData = json['data'] != null
        ? new LoanSummaryData.fromJson(json['data'])
        : null;
  }
  ...
  LoanSummaryResponseEntity toEntity() => LoanSummaryResponseEntity(
        message: message,
        loanSummaryData: loanSummaryData?.toEntity(),
      );
}
...
class LoanSummaryData {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.unpledgeList != null) {
      data['unpledge_list'] =
          this.unpledgeList!.map((v) => v.toJson()).toList();
    }
  ...
  LoanSummaryDataEntity toEntity() => LoanSummaryDataEntity(
        sellCollateralTopupAndUnpledgeList: sellCollateralTopupAndUnpledgeList
            ?.map((x) => x.toEntity())
            .toList(),
        actionableLoan: actionableLoan?.map((x) => x.toEntity()).toList(),
        underProcessLa: underProcessLa?.map((x) => x.toEntity()).toList(),
        underProcessLoanRenewalApp:
            underProcessLoanRenewalApp?.map((x) => x.toEntity()).toList(),
        activeLoans: activeLoans?.map((x) => x.toEntity()).toList(),
        sellCollateralList:
            sellCollateralList?.map((x) => x.toEntity()).toList(),
        unpledgeList: unpledgeList?.map((x) => x.toEntity()).toList(),
        topupList: topupList?.map((x) => x.toEntity()).toList(),
        increaseLoanList: increaseLoanList?.map((x) => x.toEntity()).toList(),
        instrumentType: instrumentType,
        schemeType: schemeType,
        versionDetails: versionDetails?.toEntity(),
        loanRenewalApplication:
            loanRenewalApplication?.map((x) => x.toEntity()).toList(),
      );
}
...
class SellCollateralTopupAndUnpledgeList {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.sellCollateralAvailable != null) {
      data['sell_collateral_available'] =
          this.sellCollateralAvailable!.toJson();
    }
  ...
  SellCollateralTopupAndUnpledgeListEntity toEntity() =>
      SellCollateralTopupAndUnpledgeListEntity(
        loanName: loanName,
        creation: creation,
        unpledgeApplicationAvailable: unpledgeApplicationAvailable?.toEntity(),
        sellCollateralAvailable: sellCollateralAvailable?.toEntity(),
        existingTopupApplication: existingTopupApplication?.toEntity(),
      );
}
...
class UnpledgeApplicationAvailable {
  ...
  UnpledgeApplicationAvailableEntity toEntity() =>
      UnpledgeApplicationAvailableEntity(
        ...
        unpledgeItems: unpledgeItems?.map((x) => x.toEntity()).toList(),
      );
}
...
class SellCollateralAvailable {
  ...
  SellCollateralAvailableEntity toEntity() => SellCollateralAvailableEntity(
        name: name,
        creation: creation,
        modified: modified,
        modifiedBy: modifiedBy,
        ...
        sellItems: sellItems?.map((x) => x.toEntity()).toList(),
      );
}
...
class SellItems {
  ...
  SellItemsEntity toEntity() => SellItemsEntity(
        name: name,
        creation: creation,
        modified: modified,
        modifiedBy: modifiedBy,
...
class ExistingTopupApplication {
  ...
  ExistingTopupApplicationEntity toEntity() => ExistingTopupApplicationEntity(
        name: name,
        creation: creation,
        modified: modified,
        modifiedBy: modifiedBy,
...
class ActionableLoan {
  ...
  ActionableLoanEntity toEntity() => ActionableLoanEntity(
        name: name,
...
class UnderProcessLa {
  ...
  UnderProcessLaEntity toEntity() => UnderProcessLaEntity(
        name: name,
        status: status,
      );
}
...
class UnderProcessLoanRenewalApp {
  ...
  UnderProcessLoanRenewalAppEntity toEntity() =>
      UnderProcessLoanRenewalAppEntity(
        name: name,
        status: status,
        creation: creation,
      );
...
class ActiveLoans {
  ...
  ActiveLoansEntity toEntity() => ActiveLoansEntity(
        name: name,
        drawingPower: drawingPower,
        drawingPowerStr: drawingPowerStr,
        balance: balance,
...
class SellCollateralList {
  ...
  SellCollateralListEntity toEntity() => SellCollateralListEntity(
        loanName: loanName,
        sellCollateralAvailable: sellCollateralAvailable?.toEntity(),
...
class UnpledgeList {
  ...
  UnpledgeListEntity toEntity() => UnpledgeListEntity(
        loanName: loanName,
        unpledgeApplicationAvailable: unpledgeApplicationAvailable?.toEntity(),
...
class TopupList {
  ...
  TopupListEntity toEntity() => TopupListEntity(
        loanName: loanName,
        topUpAmount: topUpAmount,
      );
}
...
class IncreaseLoanList {
  ...
  IncreaseLoanListEntity toEntity() => IncreaseLoanListEntity(
        loanName: loanName,
        increaseLoanAvailable: increaseLoanAvailable,
      );
}
...
class LoanRenewalApplication {
  ...
  LoanRenewalApplicationEntity toEntity() => LoanRenewalApplicationEntity(
        name: name,
        owner: owner,
        creation: creation,
        modified: modified,
...
class VersionDetails {
  ...
  VersionDetailsEntity toEntity() => VersionDetailsEntity(
        name: name,
        creation: creation,
        modified: modified,
        modifiedBy: modifiedBy,
