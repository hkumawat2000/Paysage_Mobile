...
import 'package:lms/aa_getx/modules/pledged_securities/data/models/request/loan_closer_request_model.dart';
import 'package:lms/aa_getx/modules/pledged_securities/data/models/response/loan_closer_response_model.dart';
import 'package:lms/aa_getx/modules/pledged_securities/data/models/response/my_pledged_securities_details_response_model.dart';
...
abstract class PledgedSecuritiesApi {
  ...
  Future<LoanCloserResponseModel> loanCloser(LoanCloserRequestModel loanCloserRequestModel);
}
