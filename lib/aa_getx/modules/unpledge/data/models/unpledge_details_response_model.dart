...
class UnpledgeDetailsResponseModel {
  String? message;
  UnpledgeData? unpledgeData;

  UnpledgeDetailsResponseModel({this.message, this.unpledgeData});

  UnpledgeDetailsResponseModel.fromJson(Map<String, dynamic> json) {
    message = json['message'];
    unpledgeData =
        json['data'] != null ? new UnpledgeData.fromJson(json['data']) : null;
  }
  ...
  UnpledgeDetailsResponseEntity toEntity() => UnpledgeDetailsResponseEntity(
        message: message,
        unpledgeData: unpledgeData?.toEntity(),
      );
}
...
class UnpledgeData {
  ...
  UnpledgeDataEntity toEntity() => UnpledgeDataEntity(
        loan: loan?.toEntity(),
        unpledge: unpledge?.toEntity(),
        collateralLedger: collateralLedger?.map((x) => x.toEntity()).toList(),
        revokeChargeDetails: revokeChargeDetails?.toEntity(),
      );
}
...
class Loan {
  ...
  LoanEntity toEntity() => LoanEntity(
        ...
        existingtotalCollateralValue: existingtotalCollateralValue,
        totalCollateralValueStr: totalCollateralValueStr,
        drawingPower: drawingPower,
        existingdrawingPower: existingdrawingPower,
...
class CollateralLedger {
  ...
  CollateralLedgerEntity toEntity() => CollateralLedgerEntity(
        isin: isin,
        psn: psn,
        folio: folio,
...
class RevokeChargeDetails {
  ...
  RevokeChargeDetails.fromJson(Map<String, dynamic> json) {
    ...
    revokeInitiateChargesMinimumAmount =
        json['revoke_initiate_charges_minimum_amount'];
    revokeInitiateChargesMaximumAmount =
        json['revoke_initiate_charges_maximum_amount'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['revoke_initiate_charges_minimum_amount'] =
        this.revokeInitiateChargesMinimumAmount;
    data['revoke_initiate_charges_maximum_amount'] =
        this.revokeInitiateChargesMaximumAmount;
    return data;
  }
...
class UnpledgeValue {
  ...
  UnpledgeValueEntity toEntity() => UnpledgeValueEntity(
