...
class AccountStatementRepositoryImpl extends AccountStatementRepository{
  ...
  @override
  ResultFuture<RecentTransactionResponseEntity> getRecentTransactions(LoanStatementRequestEntity loanStatementRequestEntity) async {
    try {
      LoanStatementRequestModel loanStatementRequestModel =
      LoanStatementRequestModel.fromEntity(
          loanStatementRequestEntity);
      final getRecentTransactionsResponse =
      await accountStatementDataSource.getRecentTransactions(
          loanStatementRequestModel);
      return DataSuccess(getRecentTransactionsResponse.toEntity());
    } on ServerException catch (e) {
      return DataFailed(ServerFailure(e.message ?? Strings.defaultErrorMsg, 0));
    } on ApiServerException catch (e) {
      return DataFailed(
