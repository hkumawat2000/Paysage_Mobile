...
class LoanStatementResponseModel {
  String? message;
  LoanData? loanData;

  LoanStatementResponseModel({this.message, this.loanData});

  LoanStatementResponseModel.fromJson(Map<String, dynamic> json) {
  ...
  LoanStatementResponseEntity toEntity() =>
      LoanStatementResponseEntity(
        message: message,
...
class LoanData {
  ...
  LoanDataEntity toEntity() =>
      LoanDataEntity(
        loan: loan?.toEntity(),
        loanTransactionList: loanTransactionList?.map((x) => x.toEntity()).toList(),
...
class LoanTransactionList {
  ...
  LoanTransactionListEntity toEntity() =>
