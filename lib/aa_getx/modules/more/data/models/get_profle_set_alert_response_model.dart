...
class GetProfileSetAlertResponseModel {
  String? message;
  AlertData? alertData;

  GetProfileSetAlertResponseModel({this.message, this.alertData});

  GetProfileSetAlertResponseModel.fromJson(Map<String, dynamic> json) {
  ...
  GetProfileSetAlertResponseEntity toEntity() =>
      GetProfileSetAlertResponseEntity(
        message: message,
