...
class LoanWithdrawSuccessView extends StatefulWidget {
  String loanName, withdrawAmount,accountNumber;
  @override
  LoanWithdrawSuccessViewState createState() => new LoanWithdrawSuccessViewState();
  LoanWithdrawSuccessView(this.loanName,this.withdrawAmount,this.accountNumber);
}

class LoanWithdrawSuccessViewState extends State<LoanWithdrawSuccessView> with TickerProviderStateMixin {
