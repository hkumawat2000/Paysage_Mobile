...
import '../pledge_eligibility/mutual_fund/MF_ViewVaultDetailsViewScreen.dart';
import '../shares/LoanApplicationBloc.dart';
import '../terms_conditions/TermsConditions.dart';
...
class MFIncreaseLoanMyVault extends StatefulWidget {
...
class _MFIncreaseLoanMyVaultState extends State<MFIncreaseLoanMyVault> {
  ...
  Future<bool> _onBackPressed() async {
    Navigator.pop(context, schemesList);
    return true;
  }
                      ...
                      children: <Widget>[
                        ...
                        Row(
                          ...
                          children: <Widget>[
                            ...
                            Text(
                              "Rs.${numberToString(widget.loanData!.marginShortfall!.minimumCashAmount!.toStringAsFixed(2))}",
                              style: TextStyle(
                                  fontSize: 18,
                                  fontWeight: FontWeight.bold,
                                  color: red),
