...
import '../lender/LenderBloc.dart';
import '../network/requestbean/MFSchemeRequest.dart';
import '../network/requestbean/MyCartRequestBean.dart';
import '../network/responsebean/MFSchemeResponse.dart';
import '../network/responsebean/MyCartResponseBean.dart';
import '../pledge_eligibility/mutual_fund/MFSchemeBloc.dart';
import '../util/AssetsImagePath.dart';
import '../util/Colors.dart';
import '../util/Style.dart';
import '../util/Utility.dart';
import '../util/strings.dart';
import '../widgets/ErrorMessageWidget.dart';
import '../widgets/LoadingDialogWidget.dart';
import '../widgets/LoadingWidget.dart';
import '../widgets/NoDataWidget.dart';
import '../widgets/WidgetCommon.dart';
import 'MFIncreaseLoanMyVault.dart';

class MFIncreaseLoan extends StatefulWidget {
  String loanName, comingFrom, loanType, schemeType;
  LoanDetailData? loanData;

  MFIncreaseLoan(this.loanName, this.comingFrom, this.loanData, this.loanType, this.schemeType);

  @override
  State<MFIncreaseLoan> createState() => _MFIncreaseLoanState();
}

class _MFIncreaseLoanState extends State<MFIncreaseLoan> {
            ...
            delegate: SliverChildListDelegate([
              widget.comingFrom == Strings.margin_shortfall ? Padding(
                ...
                child: marginShortFall(context,
                    ...
                    widget.loanData!.marginShortfall!.minimumPledgeAmount,
                    widget.loanData!.marginShortfall!.minimumCashAmount,
                    widget.loanData!.marginShortfall!.drawingPower,
                    AssetsImagePath.business_finance,
                    colorLightRed,
                    false, Strings.mutual_fund),
              ) : Container(),
              SizedBox(
                  height : 0.5
              ),
        ...
        children: <Widget>[
          Padding(
            ...
            child: Row(
              children: [
                Expanded(
                    child: Text(schemeType!, style: extraBoldTextStyle_14)
                ),
                ...
                Expanded(
                  child: GestureDetector(
                    child: Row(
                      ...
                      children: [
                        Text(Strings.filter, style: extraBoldTextStyle_14),
                        SizedBox(width: 4),
                              ...
                              if (isNetwork){
                                ...
                                if(!levelCheckBox.contains(true)){
                                  ...
                                  if(!isEqual){
                                    ...
                                    _handleSearchEnd();
                                    mFSchemeBloc.getSchemesList(MFSchemeRequest(schemeType,
  ...
  Widget schemesListWidget() {
    return Padding(
      padding: const EdgeInsets.only(left: 10.0, top: 0, right: 10, bottom: 150),
                              ...
                              children: <Widget>[
                                Stack(
                                  children: <Widget>[
                                    ...
                                    //                     schemesList[index].schemeValue = schemeValue;
                                    //                     schemesList[index].eligibleLoanAmount = eligibleLoanAmount;
                                    ...
                                    //                         return MF_DetailViewDialog(schemesList[index], value.data!.isinDetails, _currentMutualFundOption, lenderList[0], schemesListAfterFilter, unitControllersList[actualIndex].text.toString());
                                    //                       },
                                    //                     );
                            ...
                            if (isNetwork) {
                              ...
                              if(schemeValue <= 999999999999){
                                ...
                                MyCartRequestBean(
                                  ...
                                  loan_margin_shortfall_name: widget.comingFrom == Strings.margin_shortfall ? widget.loanData!.marginShortfall!.name : "",
                                  pledgor_boid: "",
                                  cartName: "",
                                ...
                                List<CartItems> schemesList = await Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => MFIncreaseLoanMyVault(requestBean, widget.comingFrom, widget.loanType, widget.loanData)));
                                updateQuantity(schemesList);
                              } else {
  ...
  updateQuantity(List<CartItems> schemesList){
    for(int i=0; i<schemesListAfterFilter.length; i++){
      String index = "null";
      double qty = 0;
                                  ...
                                  if (isNetwork) {
                                    ...
                                    if(schemeValue <= 999999999999){
                                      ...
                                      Navigator.push(context,
                                          MaterialPageRoute(builder: (BuildContext context) => MFIncreaseLoanMyVault(requestBean, widget.comingFrom, widget.loanType, widget.loanData)));
                                    } else {
                                      commonDialog(context, Strings.scheme_validation, 0);
                                    }
                                  } else {
